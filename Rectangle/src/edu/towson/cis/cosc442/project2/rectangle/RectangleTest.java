...
public class RectangleTest {
	...
	public void testGetWidth() {
		assertEquals(2.0, rect1.getWidth(), 0.0001);
		assertEquals(2.0, rect2.getWidth(), 0.0001);
	}
	
	/**
	 * Test for the getHeight() method of the {@link Rectangle} class.
	 */
	@Test
	public void testGetHeight() {
		assertEquals(5.0, rect1.getHeight(), 0.0001);
		assertEquals(3.0, rect2.getHeight(), 0.0001);
	}
