...
public class Main {
    ...
    public static void mainMenu() {
        ...
        System.out.println("0. Exit" + lineSep);
	...
	public static void addRecipe() {
	    //Read in recipe name
	    final String name = inputOutput(lineSep + "Please enter the recipe name: ");
	    
	    //Read in recipe price
	    final String priceString = inputOutput(lineSep + "Please enter the recipe price: $");
	    ...
	    //Read in amt coffee
	    final String coffeeString = inputOutput(lineSep + "Please enter the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput(lineSep + "Please enter the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput(lineSep + "Please enter the units of sugar in the recipe: ");
	    ...
	    final String chocolateString = inputOutput(lineSep + "Please enter the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
	    String coffeeString = inputOutput(lineSep + "Please enter the units of coffee to add: ");
	    final int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput(lineSep + "Please enter the units of milk to add: ");
	    final int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput(lineSep + "Please enter the units of sugar to add: ");
	    ...
	    //Read in amt chocolate
	    String chocolateString = inputOutput(lineSep + "Please enter the units of chocolate to add: ");
    ...
    public static void makeCoffee() {
        ...
        System.out.println("Your change is: " + change + lineSep);
        mainMenu();
    }
    ...
    private static int stringToInt(String value) {
        ...
        try {
            ...
            System.out.println("Please input an integer" + lineSep);
        }
        return returnInt;
    }
    ...
    public static void main(String[] args) {
	    ...
	    System.out.println("Welcome to the CoffeeMaker!" + lineSep);
	    mainMenu();
	}
}
